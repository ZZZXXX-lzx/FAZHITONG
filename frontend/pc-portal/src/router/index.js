...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'regulations', name: 'Regulations', component: () => import('@/views/c/regulations/RegulationLibrary.vue'), meta: { title: '法律法规库' } },
      ...
      { path: 'enterprise/investment', name: 'EnterpriseInvestment', component: () => import('@/views/enterprise/investment/InvestmentManage.vue'), meta: { title: '投融资管理', roles: ['ENTERPRISE', 'ADMIN'] } },
      { path: 'enterprise/legal-review', name: 'EnterpriseLegalReview', component: () => import('@/views/enterprise/legal-review/LegalReviewManage.vue'), meta: { title: '法律审核', roles: ['ENTERPRISE', 'ADMIN'] } },
